...
# load
final_route_RU_to_NL = joblib.load('./processing/pr_inter_output/iter{win_time_slide-1}.joblib')
...
route_RU_int_NL_matched_imoNr,trip_freq_dict, country_seq, port_sequence = pr.route_seq_matched_nrimo_par(
    a, alltankers_adjusted, 4, 3,  False, oiltype = 'all', loop_type = 'port')
aa = []
for df in a:
